...
unsigned long MTRand_int32::state[NMAX] = {0x0UL};
...
MTRand_int32::MTRand_int32(unsigned long s) { seed(s); init = true; }
MTRand_int32::MTRand_int32(const unsigned long* array, int size) { seed(array, size); init = true; }
