...
void CollectorExecutionInformationImplementation::startExecution(std::string function, CollectorExecutionMode mode){
    _mode=mode;
...
void Private::CollectorExecutionInformation::startExecution(std::string function,CollectorExecutionMode mode){
    if(_activate==true)
