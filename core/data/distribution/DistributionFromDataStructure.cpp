...
namespace pop{
const  std::string DistributionRegularStep::KEY= "STEP";
...
DistributionRegularStep::DistributionRegularStep()
    :uni(0,1),_table(1)
{
    this->_key = DistributionRegularStep::KEY;
}
...
void DistributionRegularStep::fromString(std::string str){
...
std::string DistributionRegularStep::toString()const throw(pexception){
    std::ostringstream oss;
    oss << this->toMatrix();
    return oss.str();
}
const  std::string DistributionIntegerRegularStep::KEY= "STEPINTEGER";
namespace
{
const bool registered_DistributionStepFunction = DistributionFactory::getInstance()->Register(  DistributionRegularStep::KEY, new DistributionRegularStep());
}
...
DistributionIntegerRegularStep::DistributionIntegerRegularStep()
    :uni(0,1),_table(1)
{
    this->_key = DistributionIntegerRegularStep::KEY;
}
...
void DistributionIntegerRegularStep::fromString(std::string str){
    std::istringstream iss(str );
    Mat2F64 m;
    iss>>m;
    this->fromMatrix(m);
...
std::string DistributionIntegerRegularStep::toString()const throw(pexception){
    std::ostringstream oss;
    oss << this->toMatrix();
    return oss.str();
}
...
namespace
{
const bool registered_DistributionStepIntegerFunction = DistributionFactory::getInstance()->Register(  DistributionIntegerRegularStep::KEY, new DistributionIntegerRegularStep());
}
...
const  std::string DistributionExpression::KEY = "EXPRESSION";
...
DistributionExpression::DistributionExpression()
{
    this->_key = DistributionExpression::KEY;
...
void DistributionExpression::fromString(std::string str){
    this->fromRegularExpression(str);
}

std::string DistributionExpression::toString()const throw(pexception){
    return this->toRegularExpression();
}

namespace
{
const bool registered_DistributionExpression = DistributionFactory::getInstance()->Register(  DistributionExpression::KEY, new DistributionExpression());
}
